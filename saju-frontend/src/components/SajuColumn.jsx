function SajuColumn({ label = "", top, bottom, horizontal = false }) {
  ...
  const characterBoxClasses =
    "w-[80px] h-[80px] flex items-center justify-center rounded-2xl overflow-hidden border";
  ...
  const renderCharacterWithElement = (char, mapping) => {
    ...
    return (
      <div
        className={`text-center ${colorClasses} w-full h-full flex flex-col items-center justify-center`}
      >
