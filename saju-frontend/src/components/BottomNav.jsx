    ...
    <nav className="fixed bottom-0 left-1/2 transform -translate-x-1/2 w-[400px] bg-white shadow-lg">
      <div className="flex">
        <Link to="/solo" className="flex-1 flex flex-col items-center py-2">
          ...
          <span className="btm-nav-label text-xs">메인</span>
        </Link>
        ...
        >
          ...
          <span className="btm-nav-label text-xs">커뮤니티</span>
        </Link>

        <Link to="/fortune" className="flex-1 flex flex-col items-center py-2">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-5 w-5 mb-1"
            fill="none"
        ...
        {isCouple ? (
          ...
          >
            ...
            <span className="btm-nav-label text-xs">캘린더</span>
          </Link>
        ) : (
          <Link to="/match" className="flex-1 flex flex-col items-center py-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5 mb-1"
              fill="none"
