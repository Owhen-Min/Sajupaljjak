    ...
    <div className="community-view-page flex flex-col h-screen">
      ...
      <div className="flex-grow overflow-y-auto">
        <div className="article-detail px-4 pb-4">
          <div className="article-card bg-white p-4 rounded-lg shadow mb-4">
              ...
              >
                <div className="flex items-end mb-2 justify-between">
                  <div className="flex items-center">
                    <span className="text-black">익명</span>
                    <span className="mx-2 text-sm text-gray-500">{comment.celestialStem}</span>
                  </div>
                  <div className="flex items-center">
                    <span className="text-sm text-gray-500">
          ...
          <div className="flex comment-input-section bg-white p-4 rounded-lg justify-between shadow mb-4">
            ...
            />
            <button 
              className="px-3 h-auto bg-[#ff6842] text-white rounded-lg hover:bg-[#ff8562] transition-colors"
            >
              확인
            </button>
